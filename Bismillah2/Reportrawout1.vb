...
Public Class Reportrawout1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bismillah2.Reportrawout1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportrawout1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reportrawout1 = New Reportrawout1()
        rpt.Site = Me.Site
        Return rpt
    End Function
