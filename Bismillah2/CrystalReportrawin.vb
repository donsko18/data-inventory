...
Public Class CrystalReportrawin
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bismillah2.CrystalReportrawin.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportrawin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportrawin = New CrystalReportrawin()
        rpt.Site = Me.Site
        Return rpt
    End Function
